export const routes = [
    ...
    {
        path: '/404', name: 'no-view', meta: { title: '404', requireAuth: false },
        component: () => import('@/views/common/404.vue')
    },
    {
        path: '/401', name: 'no-access', meta: { title: '401', requireAuth: false },
        component: () => import('@/views/common/401.vue')
    },
    {
        path: '/login', name: 'login', meta: { title: '登录', requireAuth: false },
