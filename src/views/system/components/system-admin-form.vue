    ...
    <el-dialog :title="form.id ? '编辑' : '添加'" v-model="formDialogVisibale" :before-close="handleCloseFormDialog" width="600px" :close-on-click-modal="false" :close-on-press-escape="false" append-to-body destroy-on-close>
        <el-form ref="formRef" :model="form" :rules="rules" label-width="120px" label-position="right">
            <el-form-item prop="nickname" label="显示名称">
                <el-input v-model="form.nickname" placeholder="请填写" @keyup.enter="handleSubmit"></el-input>
            </el-form-item>
            <el-form-item prop="account" label="登录账号">
                <el-input v-model="form.account" placeholder="请填写" @keyup.enter="handleSubmit"></el-input>
            </el-form-item>
            <el-form-item prop="password" label="登录密码">
                <el-input v-model="form.password" type="password" placeholder="请填写" @keyup.enter="handleSubmit" show-password></el-input>
            </el-form-item>
            <el-form-item prop="confirm_password" label="确认密码">
                <el-input v-model="form.confirm_password" type="password" placeholder="请填写" @keyup.enter="handleSubmit" show-password></el-input>
            </el-form-item>
