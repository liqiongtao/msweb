...
<script setup>
    ...
    window.onresize = () => { h.value = document.body.clientHeight - 280 }
...
<template>
    <el-card>
        <el-table :data="page.list" v-loading="loading" :height="h" style="width: 100%">
            ...
            <el-table-column prop="event_content" label="操作内容" align="center" min-width="200px" :show-overflow-tooltip="true" />
