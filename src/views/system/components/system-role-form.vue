...
<template>
    <el-dialog :title="form.id ? '编辑' : '添加'" v-model="formDialogVisibale" :before-close="handleCloseFormDialog" width="800px" :close-on-click-modal="false" :close-on-press-escape="false" append-to-body destroy-on-close>
        <el-form ref="formRef" :model="form" :rules="rules" label-width="120px" label-position="right">
            <el-form-item prop="name" label="角色名称">
                <el-input v-model="form.name" placeholder="请填写" @keyup.enter="handleSubmit" style="width: 400px"></el-input>
            </el-form-item>
            <el-form-item prop="description" label="角色描述">
                <el-input type="textarea" v-model="form.description" placeholder="请填写" @keyup.enter="handleSubmit" style="width: 400px"></el-input>
            </el-form-item>
            <el-form-item label="权限分配">
                <el-tree ref="permissions" :data="permissions" show-checkbox node-key="key" :default-checked-keys="form.view_permissions" :expand-on-click-node="false" check-on-click-node default-expand-all></el-tree>
            </el-form-item>
            <el-form-item>
