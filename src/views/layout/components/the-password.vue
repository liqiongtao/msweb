<script setup>
    ...
    const visiable = computed(() => { return props.visiable })
...
<template>
    <el-dialog class="dialog-box" v-model="visiable" width="500px" :close-on-click-modal="false" :close-on-press-escape="false" :before-close="handleClose">
        <template #header>修改密码</template>
        <el-form ref="formRef" :model="form" :rules="rules" label-width="120px">
            <el-form-item label="新密码：" prop="password">
                <el-input type="text" placeholder="请输入新密码" v-model="form.password" show-password>
                </el-input>
            </el-form-item>
